...
pkgdatadir = $(datadir)/wy60
pkglibdir = $(libdir)/wy60
pkgincludedir = $(includedir)/wy60
top_builddir = .
...
OBJEXT = o
PACKAGE = wy60
PACKAGE_BUGREPORT = markus+wy60@wy60.gutschke.com
PACKAGE_NAME = wy60
...
install_sh = /home/hharte/android/cyanogen/external/wy60/install-sh
...
installdirs:
	for dir in "$(DESTDIR)$(bindir)" "$(DESTDIR)$(man1dir)" "$(DESTDIR)$(etcdir)"; do \
